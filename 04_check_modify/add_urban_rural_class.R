...
add_urban_rural_class <- function(df){
  ...
  postcode_load <- readRDS(spdlatest_file)  |> 
    select(pc8, ur8_2022_name, ur6_2022_name, ca2019, ca2019name, hscp2019, hscp2019name, 
           datazone2022,datazone2022name,datazone2011,intzone2022, intzone2022name)
  ...
  postcode_lookup <- postcode_load %>%
    ...
    select(pc8, ur8_2022_name, ur6_2022_name, ca2019, ca2019name, hscp_locality, 
           hscp2019, hscp2019name, datazone2022,datazone2022name,intzone2022, intzone2022name)
