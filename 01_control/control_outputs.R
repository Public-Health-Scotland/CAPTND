...
most_recent_month_in_data <- as.Date("2025-05-31") # maybe could derive value from the dated output folder name instead of human input here (could easily forget to update it)
