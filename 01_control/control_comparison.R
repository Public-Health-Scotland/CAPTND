...
most_recent_month_in_data <- as.Date("2026-05-01")
...
source('06_calculations/compare_unadj_patients_waiting_monthly.R')
source('06_calculations/compare_adj_patients_waiting_monthly.R')
...
calculate_unadj_pats_waiting_monthly()
#summarise_adj_patients_waiting_monthly()
...
compare_unadj_patients_waiting_monthly()
#compare_adj_patients_waiting_monthly() 
