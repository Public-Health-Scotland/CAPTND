...
assess_variables_ref <- function(df){
  ...
  # source('10_pre_shorewise_dq/assess_ref_reason.R') # removed December 2024
  ...
  source('10_pre_shorewise_dq/assess_care_plan_inc.R')
  
  # get treatment stage to check
  vars_ref <- c(header_date_o, dataset_type_o, hb_name_o, ucpn_o, upi_o, chi_o,
                ref_date_o, ref_rec_date_o, ref_source_o, 
                # ref_reason_o, # removed December 2024
                ref_acc_o, ref_rej_date_o, ref_rej_reason_o, ref_rej_act_o, act_code_sent_date_o, 
