...
insertImage(wb, "RTT summary", paste0(product2_dir, "/product2_heatmap_", latest_date, ".png"), 
            startRow = 21, startCol = 2, width = 24, height = 13.5, units = "cm")
insertImage(wb, "RTT summary", paste0(product2_dir, "/product2_heatmap_", earliest_date, ".png"), 
            startRow = 37, startCol = 2, width = 24, height = 13.5, units = "cm")

insertImage(wb, "Data Completion", paste0(product3_dir, "/product3_closed_cases_until_", latest_date, ".png"), 
