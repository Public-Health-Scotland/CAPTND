...
Figure 1 below shows the reported reason for referral non-acceptance in NHSScotland
...
Figure 3 shows the DNA rate over the last 15 calendar months, from `r date_label_5qt`
...
<Div custom-style = "Table or chart caption">Figure 3: First contact DNA rate by health board region, `r date_label_5qt` to `r date_label`</Div>
...
could be one. It appears from figure 4 that relative deprivation can affect the DNA rate,
