...
figs_dna_simd <- read_parquet(
  ...
  mutate(prop_firstcon_dna = round(n/first_contact*100, 1))
...
Figure 1 shows the reported reason for referral non-acceptance in Scotland overall for the quarter ending `r date_label`. In `r dataset_choice` it is clear that the 
primary reason for referral non-acceptance is recorded as '`r ref_rej_reasons[[1,4]]`' `r ifelse(ref_rej_reasons[[1,4]] == "Unsuitable", "- meaning that the patient is unsuitable for the service to which they have been referred", "")` (`r ref_rej_reasons[[1,7]]`%). The next most common reason for referral non-acceptance is recorded as '`r ref_rej_reasons[[2,4]]`' `r ifelse(ref_rej_reasons[[2,4]] == "Unsuitable", "- meaning that the patient is unsuitable for the service to which they have been referred", "")` (`r ref_rej_reasons[[2,7]]`%). **include examples**  
