...
<Div custom-style = "Table or chart caption">Figure 1: Reasons for non-accepted referrals, NHSScotland, quarter ending `r date_label` ^1^</Div>
...
<Div custom-style = "Table or chart caption">Figure 2: Actions after non-accepted referrals, NHSScotland, quarter ending `r date_label` ^1,2,\*,\ \*\*\ +\ footnote\ reference^</Div>
...
<Div custom-style = "Table or chart caption">Figure 3: First contact DNA rate by health board region, 15 months up to `r date_label` ^1^</Div>
...
<Div custom-style = "Table or chart caption">Figure 4: First contact DNA rate by SIMD quintile, NHSScotland, quarter ending `r date_label` ^1,2,\*,\ \*\*\ +\ footnote\ reference^</Div>
...
track an individual’s care journey in `r dataset_label_long`. In the absence of
these identifiers, the care journey cannot be counted in CAPTND.  
