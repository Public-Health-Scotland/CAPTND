...
Table 1 shows the number of people referred to `r date_label_long`
...
The referral acceptance rate for Scotland overall in the quarter ending `r date_label` was `r tables_data2[[15,6]]` (`r table_data2[[15,2]]` accepted referrals). 
