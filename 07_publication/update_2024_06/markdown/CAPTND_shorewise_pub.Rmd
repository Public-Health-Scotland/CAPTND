...
key data variables are not available the pathway cannot be created accurately and
...
contact appointments, this also represents a delay to treatment start time. The `r dataset_choice`
DNA rate across NHSScotland in the latest quarter was `r figs_apps$"1st contact DNA rate"`%, 
...
these identifiers, the pathway cannot be created in CAPTND.  
...
using the data key identifiers. This is shown at Scotland level as well as by individual
...
`r figs_basic_opti$"Percent difference"` did not include the data key variables,
...
boards supplying the necessary data key variables for all of their referrals,
...
ability to record all of the required data key identifiers, and we expect this
