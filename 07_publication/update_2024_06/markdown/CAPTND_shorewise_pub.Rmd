...
which were not accepted in the latest quarter, `r ref_rej_reasons[[1,5]]`
(`r ref_rej_reasons[[1,7]]`%) were due to the individual
referred being unsuitable for treatment in `r dataset_choice`
...
can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/).  
