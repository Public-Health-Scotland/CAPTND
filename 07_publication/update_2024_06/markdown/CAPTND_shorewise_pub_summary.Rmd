...
<Div custom-style = "Bullet 1">
Of the `r table_data2[[15,2]]` referrals to `r dataset_choice`,
`r table_data2[[15,3]]` (`r table_data2[[15,6]]`) were accepted.
</Div>
...
<Div custom-style = "Bullet 1">
Of the `r table_data2[[15,4]]` referrals not accepted,
