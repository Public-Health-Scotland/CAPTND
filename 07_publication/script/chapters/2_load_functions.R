...
source('./07_publication/script/functions/referrals_by_care_plan_inclusion.R')
...
source('./07_publication/script/functions/create_table_firstcon_att.R')
...
source('./07_publication/script/functions/summarise_treat_group_ind.R')
source('./07_publication/script/functions/referrals_by_ppmh.R')
source('./07_publication/script/functions/summarise_discharges.R')
