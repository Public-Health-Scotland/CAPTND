...
update_mmi_dt_values <- function(wb, time_period){
    ...
    addStyle(wb, sheet = "Tab 6", style = createStyle(halign = "right"), cols = 6, rows = 15:29, stack = TRUE)
    ...
    writeData(wb, sheet = "Tab 7 Data", 
              x = tot_dnas_latest,  
              startCol = 2, startRow = 2, headerStyle = style_text, colNames = FALSE)
    addStyle(wb, sheet = "Tab 7", style = style_count, cols = 3, rows = 14:28, stack = TRUE)
    addStyle(wb, sheet = "Tab 7", style = style_count, cols = 4, rows = 14:28, stack = TRUE)
    addStyle(wb, sheet = "Tab 7", style = createStyle(halign = "right"), cols = 5, rows = 14:28, stack = TRUE)
    
    writeData(wb, sheet = "Tab 7", 
              x = df_months,  
              startCol = 2, startRow = 14, headerStyle = style_date, colNames = FALSE)
    addStyle(wb, sheet = "Tab 7", style = style_date, cols = 2, rows = 14:28, stack = TRUE)
