...
PT across NHSScotland between `r date_label_5qt` and `r date_label`.
...
Figure 5 shows the source of referrals for people referred to PT services across
...
Figure 6 shows the most common locations in which PT appointments were conducted
...
Figure 7 shows the most common professional groups conducting PT appointments
...
Figure 8 shows the first contact DNA rate over the last 15 calendar months, from
...
in CAPTND. For PT, first contact DNA rates appear highest across the West and North 
...
Figure 9 shows the first contact DNA rate for Scotland as a whole in the quarter
...
could be one. Figure 9 shows that with individuals from the most deprived areas are more likely
