...
<Div custom-style = "Bullet 1">
`r figs_apps_qt$current_qt` PT appointments were allocated and 
...
<Div custom-style = "Table or chart caption">Figure 5: Most common sources of PT referrals, NHS Scotland, quarter ending `r date_label`</Div>
...
By far the most common contact location recorded in which PT appointments were 
...
<Div custom-style = "Table or chart caption">Figure 6: Most common contact locations of PT appointments, NHS Scotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 7: Most common professional groups conducting PT appointments, NHS Scotland, quarter ending `r date_label`</Div>
...
There is some suggestion that the first contact DNA rate has becoming more consistent
