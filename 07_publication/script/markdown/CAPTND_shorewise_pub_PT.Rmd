...
could be one. It appears from figure 10 that relative deprivation can affect the
...
Table 5 presents a comparison of total referral counts in PT
...
<Div custom-style = "Table or chart caption">Table 5: Difference between submitted referral counts and CAPTND pathway referral counts, in PT by health board, quarter ending `r date_label` ^1,2^</Div>
