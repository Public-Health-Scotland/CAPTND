...
not be compared to the [official aggregate PT collection and waiting times](https://publichealthscotland.scot/publications/psychological-therapies-waiting-times/psychological-therapies-waiting-times-quarter-ending-march-2025/). 

For PT data recorded in CAPTND across NHSScotland, in the quarter ending `r date_label`:
...
NHSScotland between `r date_label_5qt` and `r date_label`,
...
can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/).   
...
<Div custom-style = "Table or chart caption">Figure 4: Actions taken following non-accepted referrals, NHSScotland, quarter ending `r date_label`</Div>
...
The most common referral source to PT services, across NHSScotland for the quarter 
ending `r date_label`, was '`r ref_source[[1,4]]`'(`r ref_source[[1,7]]`%), followed 
by '`r ref_source[[2,4]]`' (`r ref_source[[2,7]]`%) (Figure 5).  

<Div custom-style = "Table or chart caption">Figure 5: Most common sources of PT referrals, NHSScotland, quarter ending `r date_label`</Div>
...
previous quarters can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/).    
...
conducted across NHSScotland for the quarter ending `r date_label` was '`r appt_loc[[1,3]]`'
...
(`r appt_loc_missing_fig[[1,5]]`) of total PT appointments across NHSScotland in
the most recent quarter (Figure 6).  

<Div custom-style = "Table or chart caption">Figure 6: Most common contact locations of PT appointments, NHSScotland, quarter ending `r date_label`</Div>
...
The professional group most commonly recorded as conducting PT appointments across NHSScotland for the 
...
<Div custom-style = "Table or chart caption">Figure 7: Most common professional groups conducting PT appointments, NHSScotland, quarter ending `r date_label`</Div>
...
Of the `r figs_apps_qt$current_qt` total appointments in PT across NHSScotland in the
...
<Div custom-style = "Table or chart caption">Figure 9: First contact DNA rate by SIMD quintile, NHSScotland, quarter ending `r date_label`</Div>
...
# Further Information
Further information and data for this publication are available from the [publication page](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/) on our website.

The next release of this publication will be `r next_pub_date`.

# Rate this publication
Let us know what you think about this publication via. the link at the bottom of this [publication page](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/) on the PHS website.
