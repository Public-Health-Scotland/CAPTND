...
<Div custom-style = "Bullet 1"> 
`r figs_referrals$current_qt` people of all ages were referred. This was 
...
<Div custom-style = "Bullet 1">
`r figs_apps_qt$current_qt` PT appointments were allocated and recorded 
...
<Div custom-style = "Bullet 1">
Of the `r figs_apps_qt$current_qt` appointments recorded, `r figs_tot_apps[[1,2]]` 
had an attendance status of 'Did Not Attend (DNA)' 
...
`r agesex_total[[2,3]]` (`r agesex_total[[2,4]]`%) males referred to PT across 
NHS Scotland between `r date_label_5qt` and `r date_label`,
with the remainder (`r agesex_total[[3,4]]`%) recorded as 'not known' or 'not specified'
(Figure 1). See [Variables Reported](#variables-reported) for more information.  
...
In the quarter ending `r date_label`, PT across NHS Scotland
...
<Div custom-style = "Table or chart caption">Figure 1: Age distribution of PT referrals by sex, NHS Scotland, from `r date_label_5qt` to `r date_label`</Div>
...
`r figs_simd_refs[[1,5]]` (`r figs_simd_refs[[1,6]]`%) individuals referred to PT, in the 
quarter ending `r date_label`, lived in the most deprived 20% of neighbourhoods across Scotland, 
whereas `r figs_simd_refs[[2,5]]` (`r figs_simd_refs[[2,6]]`%) were from the least
deprived 20% of neighbourhoods (Figure 2). See [Variables Reported](#variables-reported)
section for more information.  

This demonstrates that a higher demand for PT services exists in areas of higher deprivation.  

<Div custom-style = "Table or chart caption">Figure 2: Total referrals to PT by SIMD quintile, NHS Scotland, quarter ending `r date_label`</Div>
...
can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-3-march-2026/).   
...
Figure 3 below shows the reported reason for referral non-acceptance in NHS Scotland
...
<Div custom-style = "Table or chart caption">Figure 3: Reasons for non-accepted referrals, NHS Scotland, quarter ending `r date_label`</Div>
...
For records where a non-acceptance action was recorded, the majority
...
<Div custom-style = "Table or chart caption">Figure 4: Actions taken following non-accepted referrals, NHS Scotland, quarter ending `r date_label`</Div>
...
The most common referral source to PT services, across NHS Scotland for the quarter 
ending `r date_label`, was '`r ref_source[[1,4]]`'(`r ref_source[[1,7]]`%), followed 
by '`r ref_source[[2,4]]`' (`r ref_source[[2,7]]`%) (Figure 5).  

<Div custom-style = "Table or chart caption">Figure 5: Five most common sources of PT referrals, NHS Scotland, quarter ending `r date_label`</Div>
...
previous quarters can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/psychological-therapies-in-child-adolescent-and-psychological-therapies-national-dataset-3-march-2026/).    
...
The most common contact location in which PT appointments were 
conducted across NHS Scotland for the quarter ending `r date_label` was '`r appt_loc[[1,3]]`'
...
(`r appt_loc_missing_fig[[1,5]]`) of total PT appointments across NHS Scotland in
the most recent quarter (Figure 6).  

<Div custom-style = "Table or chart caption">Figure 6: Five most common contact locations of PT appointments, NHS Scotland, quarter ending `r date_label`</Div>
...
The professional group most commonly recorded as conducting PT appointments across NHS Scotland for the 
quarter ending `r date_label` was '`r prof_group[[1,3]]`' (`r prof_group[[1,7]]`%), 
followed by '`r prof_group[[2,3]]`' (`r prof_group[[2,7]]`%).
Professional group data were missing for `r prof_group_missing_fig[[1,7]]`%
(`r prof_group_missing_fig[[1,5]]`) of total PT appointments across NHS Scotland
for the most recent quarter (Figure 7).  

<Div custom-style = "Table or chart caption">Figure 7: Five most common professional groups conducting PT appointments, NHS Scotland, quarter ending `r date_label`</Div>
...
There is a suggestion that the first contact DNA rate has becoming more consistent
across some geographical regions over the last 15 calendar months, which is likely 
due to the improving data quality in CAPTND. For PT, first contact DNA rates 
appeared highest across the West and North regions up until September 2025. Rates across the 
East region have since increased in line with the rest of Scotland. This is likely 
attributable to changes in methodologies used to extract data at board level in NHS Lothian, 
rather than a true increase in patient DNAs (Figure 8) (see [Glossary](#glossary) section for more information).


<Div custom-style = "Table or chart caption">Figure 8: First contact DNA rate by health board region, `r date_label_5qt` to `r date_label`^a^</Div>
...
quarter ending `r date_label` (Figure 9) 
(see [Variables reported](#variables-reported) section for more information).  

\newpage

<Div custom-style = "Table or chart caption">Figure 9: First contact DNA rate by SIMD quintile, NHS Scotland, quarter ending `r date_label`</Div>
