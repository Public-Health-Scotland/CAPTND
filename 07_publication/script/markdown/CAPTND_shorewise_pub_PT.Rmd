...
For PT data recorded in CAPTND, in the quarter ending `r date_label`:
...
between the geographical regions over the last 15 calendar months, from `r date_label_5qt` 
to `r date_label`, which is likely due to the improving data quality in CAPTND. 
For PT, first contact DNA rates appear highest across the West and North 
regions, with the rate in the East having fallen and stabilised at around 5% since January
2025 (Figure 8) (see [Glossary](#glossary) section for more information). 
