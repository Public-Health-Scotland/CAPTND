...
Figure 3 shows the proportion of individuals referred to PT services identifying as belonging
...
of PT referrals by ethnic group to the proportion of the Scottish population
identifying with each of those ethnic groups.  

<Div custom-style = "Table or chart caption">Figure 3: Total referrals to PT by ethnic group, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 6: Top five sources of PT referrals, NHSScotland, quarter ending `r date_label`</Div>
...
previous quarters can be seen in the accompanying [data files]`r paste0("(https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/", dataset_choice, "-in-captnd-4-march-2025/)")`.  
...
<Div custom-style = "Table or chart caption">Figure 7: Top five contact locations of PT appointments, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 8: Top five professional groups conducting PT appointments, NHSScotland, quarter ending `r date_label`</Div>
...
between the geographical regions, which is likely due tot he improving data quality
in CAPTND. Overall, the first contact DNA rate seems fairly stable over time.  
