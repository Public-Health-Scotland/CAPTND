...
location recorded was '`r appt_loc[[1,3]]`' (`r appt_loc[[1,7]]`%). This was followed by 
'`r appt_loc[[2,3]]`', the care location recorded for `r appt_loc[[2,7]]`% of PT appointments. 
Contact location data was missing for `r appt_loc_missing_fig[[1,7]]`% (`r appt_loc_missing_fig[[1,5]]`) 
of total PT appointments across NHSScotland in the most recent quarter.  
