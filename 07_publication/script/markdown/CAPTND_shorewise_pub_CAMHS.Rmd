...
<Div custom-style = "Bullet 1">
Of the total `r ifelse(dataset_choice == "CAMHS", "CAMHS", "PT")` appointments across NHSScotland, `r figs_tot_apps[[1,2]]` had an attendance status of 'Did Not Attend (DNA)' resulting in a total DNA rate of `r figs_tot_apps[[1,3]] ` for all appointments.
</Div>
