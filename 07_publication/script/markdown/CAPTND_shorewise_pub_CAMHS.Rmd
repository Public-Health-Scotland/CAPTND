...
source("/PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/scripts/bex/CAPTND/07_publication/script/markdown/source_data_for_markdown.R", local = knitr::knit_global())
...
ethnic identities (see [Glossary](#glossary) for further information). The
...
‘white’ ethnic group (see ScotPHO).  
...
It is well documented that those belonging to marginalised minority ethnic groups
are more likely to experience mental health difficulties **REF**, but also that they may
face barriers to accessing mental health services. With such a high proportion of
‘not known’ responses in CAPTND it it not possible to compare the distributions
of CAMHS referrals by ethnic group to the proportion of the Scottish population
identifying with each of those ethnic groups.  
...
<Div custom-style = "Table or chart caption">Figure 7: Actions after non-accepted referrals, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 8: Top five sources of CAMHS referrals, NHSScotland, quarter ending `r date_label`</Div>
...
[Glossary](#glossary) section for more information). Of `r figs_apps_qt$current_qt`
total appointments, the overall DNA rate was `r figs_tot_apps[[1,3]]`%
(`r figs_tot_apps[[1,2]]` appointments not attended).  

<Div custom-style = "Table or chart caption">Table 3: CAMHS total appointments and total DNA rate by health board, quarter ending `r date_label` ^1,2,3^</Div>
...
location recorded was '`r appt_loc[[1,3]]`' (`r appt_loc[[1,7]]`%). The next
most common contact location recorded was '`r appt_loc[[2,3]]`' (`r appt_loc[[2,7]]`%).
Contact location data was missing for `r appt_loc_missing_fig[[1,7]]`%
(`r appt_loc_missing_fig[[1,5]]`) of total CAMHS appointments across NHSScotland
in the most recent quarter.  

<Div custom-style = "Table or chart caption">Figure 9: Top five contact locations for CAMHS appointments, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 10: Top five professional groups conducting CAMHS appointments, NHSScotland, quarter ending `r date_label`</Div>
...
represent a delay to treatment starting The CAMHS DNA rate across NHSScotland in the
...
<Div custom-style = "Table or chart caption">Table 4: CAMHS first contact appointments and first contact DNA rate by health board, quarter ending `r date_label`, with DNA rate for first contact appointments ^1,2^</Div>
...
<Div custom-style = "Table or chart caption">Figure 11: First contact DNA rate by health board region, `r date_label_5qt` to `r date_label`</Div>
...
could be one. It appears from figure 6 that relative deprivation can affect the
first contact DNA rate, **with individuals from the most deprived areas more likely
to DNA a first contact appointment (`r figs_dna_simd[[1,10]]`%) than those from
...
this occurs out of all appointments. If for first contact appointments only this
