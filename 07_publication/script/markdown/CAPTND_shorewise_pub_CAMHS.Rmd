...
and after pathway creation can be found in [Appendix 2](#appendix-2) 
section below.  
...
**Figure 3 - text on ethnicity to be added.**  

<Div custom-style = "Table or chart caption">Figure 3: Total referrals to CAMHS by ethnicity, NHSScotland, quarter ending `r date_label`</Div>
...
[data files]`r paste0("(https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/", dataset_choice, "-in-captnd-3-september-2024/)")`.  
