...
In CAMHS the primary reason for referral non-acceptance was recorded as '`r ref_rej_reasons[[1,4]]`' (`r ref_rej_reasons[[1,7]]`%)`r ifelse(ref_rej_reasons[[1,4]] == "Unsuitable", " - meaning that the patient is unsuitable for the service to which they have been referred. A patient may be deemed unsuitable for CAMHS because their needs would be better met in another branch of mental health services, e.g. neurodevelopmental services.", "")`. The next most common reason for
referral non-acceptance was recorded as '`r ref_rej_reasons[[2,4]]`' (`r ref_rej_reasons[[2,7]]`%)`r ifelse(ref_rej_reasons[[2,4]] == "Unsuitable", " - meaning that the patient is unsuitable for the service to which they have been referred. A patient may be deemed unsuitable for CAMHS because their needs would be better met in another branch of mental health services, e.g. neurodevelopmental services.", "")`.   
...
previous quarters can be seen in the accompanying [data files]`r paste0("(https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/", dataset_choice, "-in-captnd-3-september-2024/)")`.
...
Figure 11 shows the DNA rate over the last 15 calendar months, from `r date_label_5qt`
