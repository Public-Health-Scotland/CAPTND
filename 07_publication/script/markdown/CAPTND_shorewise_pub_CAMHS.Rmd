...
are more likely to experience mental health difficulties, but also that they may
face barriers to accessing mental health services **REF**. However, due to the high proportion of
‘not known’ responses for ethnicity in CAPTND means that it is not possible to accurately compare the distributions
...
```
<Div custom-style = "Table or chart note">
1. \ \ \ The decrease in first contact DNA rate in Eastern region from October 2024 onwards is likely due to NHS Lothian updating query report for data extraction. 
<br>
...
could be one. It appears from figure 12 that relative deprivation can affect the
...
<Div custom-style = "Table or chart caption">Table 5: Difference between submitted referral counts and CAPTND pathway referral counts, in CAMHS by health board, quarter ending `r date_label` ^1,2^</Div>
