...
and after pathway creation can be found in the accompanying [data quality document](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/). 
...
inferences or conclusions from this analysis must be treated with caution, and 
should not be compared to the [official aggregate CAMHS collection and waiting times](https://publichealthscotland.scot/publications/child-and-adolescent-mental-health-services-camhs-waiting-times/child-and-adolescent-mental-health-services-camhs-waiting-times-quarter-ending-march-2025/).    

For CAMHS data recorded in CAPTND across NHSScotland, in the quarter ending `r date_label`:
...
activity section of the accompanying [data quality document](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/), and the [national neurodevelopmental specification: principles and standards of care](https://www.gov.scot/publications/national-neurodevelopmental-specification-children-young-people-principles-standards-care/) for more information. 
...
NHSScotland between `r date_label_5qt` and `r date_label`, with the remainder 
...
in NHSScotland, for the quarter ending `r date_label`. Of the `r ref_lac[[1,6]]`
...
<Div custom-style = "Table or chart caption">Figure 3: Looked after child status of CAMHS referrals, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 4: Child protection status of CAMHS referrals, NHSScotland, quarter ending `r date_label`</Div>
...
can be seen in the accompanying [data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/).     
...
Figure 5 below shows the reported reason for referral non-acceptance in NHSScotland
...
<Div custom-style = "Table or chart caption">Figure 5: Reasons for non-accepted referrals, NHSScotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 6: Actions taken following non-accepted referrals, NHSScotland, quarter ending `r date_label`</Div>
...
The most common referral source to CAMHS services, across NHSScotland for the quarter
ending `r date_label`, was '`r ref_source[[1,4]]`' (`r ref_source[[1,7]]`%), followed by
'`r ref_source[[2,4]]`' (`r ref_source[[2,7]]`%) (Figure 7).  

<Div custom-style = "Table or chart caption">Figure 7: Most common sources of CAMHS referrals, NHSScotland, quarter ending `r date_label`</Div>
...
[data files](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/).    
...
across NHSScotland for the quarter ending `r date_label` was '`r appt_loc[[1,3]]`' 
...
<Div custom-style = "Table or chart caption">Figure 8: Most common contact locations for CAMHS appointments, NHSScotland, quarter ending `r date_label`</Div>
...
NHSScotland for the quarter ending `r date_label` was '`r prof_group[[1,3]]`'
...
CAMHS appointments across NHSScotland for the most recent quarter (Figure 9).  

<Div custom-style = "Table or chart caption">Figure 9: Most common professional groups conducting CAMHS appointments, NHSScotland, quarter ending `r date_label`</Div>
...
Of the `r figs_apps_qt$current_qt` total appointments in CAMHS across NHSScotland in the
...
represent a delay to treatment starting. The CAMHS first contact DNA rate across NHSScotland in the
...
```
<Div custom-style = "Table or chart note">
a.	Variability in first contact DNA rates in the East region between October 2024 and December 2025 are likely due to NHS Lothian updating the report used for data extraction at board level.
<br>
...
the least deprived areas (`r figs_dna_simd[[5,10]]`%) across NHSScotland for the 
quarter ending `r date_label` (Figure 11) (see [Variables reported](#variables-reported) 
section for more information).

\newpage

<Div custom-style = "Table or chart caption">Figure 11: First contact DNA rate by SIMD quintile, NHSScotland, quarter ending `r date_label`</Div>
...
# Further Information
Further information and data for this publication are available from the [publication page](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/) on our website.

The next release of this publication will be `r next_pub_date`.

# Rate this publication
Let us know what you think about this publication via. the link at the bottom of this [publication page](https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/child-and-adolescent-mental-health-services-in-child-adolescent-and-psychological-therapies-national-dataset-2-september-2025/) on the PHS website.
