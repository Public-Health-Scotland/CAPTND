...
Table x shows the rate of total appointment DNAs recorded in CAPTND for CAMHS in
the latest quarter, for each health board and for NHSScotland overall. Data for 
previous quarters
can be seen in the accompanying [data files]`r paste0("(https://publichealthscotland.scot/publications/child-adolescent-and-psychological-therapies-national-dataset-captnd/", dataset_choice, "-in-captnd-3-september-2024/)")`.

Of the `r dna_rate[[5,5]]` CAMHS appointments recorded for the quarter ending 
`r date_label`, the DNA rate for NHSScotland was `r dna_rate[[5,6]]`% 
(`r dna_rate[[5,4]]` appointments not attended).

The total appointment DNA rate in the previous quarter (ending `r date_label_qt`) 
was `r dna_rate[[4,6]]`%, and for the quarter ending `r date_label_yr` it was 
`r dna_rate[[1,6]]`%. 
