...
with the remainder (`r agesex_total[[3,4]]`%) recorded as 'not known' or 'not specified'
...
Figure 7 shows the source of referrals for people referred to CAMHS services across
...
Figure 8 shows the most common locations in which CAMHS appointments were conducted
...
Figure 9 shows the most common professional groups conducting CAMHS appointments
...
Figure 10 shows the first contact DNA rate over the last 15 calendar months, from
...
Figure 11 shows the first contact DNA rate for Scotland as a whole in the quarter
...
could be one. Figure 11 shows that individuals from the most deprived areas are more likely
