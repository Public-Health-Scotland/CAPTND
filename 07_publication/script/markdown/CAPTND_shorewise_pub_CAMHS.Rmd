...
For CAMHS data recorded in CAPTND, in the quarter ending `r date_label`:
...
recorded in CAPTND across NHSScotland. This is
...
<Div custom-style = "Bullet 1">
Of the `r figs_apps_qt$current_qt` appointments recorded across 
...
CAMHS has declined slightly over the reporting period.  
...
The first contact DNA rate for CAMHS has shown variability across geographic 
regions over the last 15 calendar months, from `r date_label_5qt` to `r date_label`. 
Since January 2025, however, rates in the West and East regions 
seem to have stabilised, which is likely due to the improving data quality in CAPTND. 
First contact DNA rates appear highest across both the North and West regions, with the East
now consistently recording a first contact DNA rate below 5% (Figure 10) (see [Glossary](#glossary)
section for more information).  
