...
<Div custom-style = "Bullet 1">
`r figs_apps_qt$current_qt` CAMHS appointments were allocated and recorded 
in CAPTND. This is `r ifelse(figs_apps_qt$diff_qt > 0, "an increase", "a decrease")`
of `r gsub("-", "", figs_apps_qt$prop_qt)`% from the `r figs_apps_qt$last_qt` 
total recorded appointments in the previous quarter, 
and `r ifelse(figs_apps_qt$diff_yr > 0, "an increase", "a decrease")` 
of `r gsub("-", "", figs_apps_qt$prop_yr)`% from the `r figs_apps_qt$last_yr` recorded 
appointments in the same quarter ending `r date_label_yr`.  Note this may be reflective
of the improved data quality of submissions, rather than an actual increase in service demand. 
</Div>
...
There were a total of `r agesex_total[[1,3]]` (`r agesex_total[[1,4]]`%) females and
...
individuals were identified as a looked after child at time of referral.  
...
who were identified as on the Child Protection Register for the most recent
...
<Div custom-style = "Table or chart caption">Figure 7: Five most common sources of CAMHS referrals, NHS Scotland, quarter ending `r date_label`</Div>
...
(`r appt_loc[[1,7]]`%), followed by '`r appt_loc[[2,3]]`' (`r appt_loc[[2,7]]`%). 
...
<Div custom-style = "Table or chart caption">Figure 8: Five most common contact locations for CAMHS appointments, NHS Scotland, quarter ending `r date_label`</Div>
...
<Div custom-style = "Table or chart caption">Figure 9: Five most common professional groups conducting CAMHS appointments, NHS Scotland, quarter ending `r date_label`</Div>
