...
<Div custom-style = "Table or chart caption">Figure : Total DNA rate by age group and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
### CAMHS total DNA rate by SIMD

<Div custom-style = "Table or chart caption">Figure : Total DNA rate by age group and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_simd_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_att/tot_dna_simd_CAMHS.png"))

```

### CAMHS total DNA rate by urban rural classification

<Div custom-style = "Table or chart caption">Figure : Total DNA rate by urban rural classification, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_ur_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_att/tot_dna_ur_CAMHS.png"))

```

### CAMHS total DNA rate by appointment location

<Div custom-style = "Table or chart caption">Figure : Total DNA rate by location of planned appointment, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_loc_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_att/tot_dna_loc_CAMHS.png"))

```

### CAMHS total DNA rate by weekday of planned appointment

<Div custom-style = "Table or chart caption">Figure : Total DNA rate by weekday planned appointment, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_weekday_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_att/tot_dna_weekday_CAMHS.png"))
...
<Div custom-style = "Table or chart caption">Figure : First contact DNA rate by health board region, March 2025 to June 2026 ^a^</Div>
```{r first_con_dnas_by_geo_chart, fig.width=7.18, fig.height=3.31, include = TRUE}
...
<Div custom-style = "Table or chart caption">Figure : First contact DNA rate by SIMD quintile, NHS Scotland, March 2025 to June 2026 </Div>
...
### CAMHS first contact DNA rate by SIMD
...
<Div custom-style = "Table or chart caption">Figure : First contact DNA rate by SIMD quintile, NHS Scotland, March 2025 to June 2026 </Div>
```{r first_con_dnas_by_simd_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_firstcon/dna_simd_CAMHS.png"))
