...
<Div custom-style = "Table or chart caption">Table 1: CAMHS total appointments and total DNA rate by health board, March 2025 to June 2026 ^a^</Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by aggregated age group and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
### CAMHS total DNA rate by age group by month

<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by aggregated age group and reporting month, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_age_mth fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_loc/dna_agg_age_tt_CAMHS.png"))

```   

### CAMHS total DNA rate by SIMD and sex

<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by SIMD quintile and sex reported at referral, NHS Scotland, March 2025 to June 2026, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by urban rural classification and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by location of planned appointment and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointments and crude DNA rate for top 10 most common planned appointment locations for patients living in the most deprived SIMD quintile, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointments and crude DNA rate for top 10 most common planned appointment locations for patients living in the least deprived SIMD quintile, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by health board region, March 2025 to June 2026 ^a^</Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by weekday planned appointment, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Table 2: CAMHS first contact appointments and first contact DNA rate by health board, March 2025 to June 2026 ^a^</Div>
...
<Div custom-style = "Table or chart caption">Figure : First contact crude DNA rate by aggregated age group and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : First contact crude DNA rate by SIMD quintile and sex reported, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : First contact crude DNA rate by urban rural classification and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
```{r tot_dnas_by_ur_sex_chart, fig.width=7.18, fig.height=3.31, include = TRUE}

knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_firstcon/tot_dna_ur_sex_CAMHS.png"))

```    

### CAMHS first contact DNA rate by length of wait

<Div custom-style = "Table or chart caption">Figure : First contact crude DNA rate by length of wait in weeks for first contact appointment, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : First contact crude DNA rate by health board region, March 2025 to June 2026 ^a^</Div>
...
<Div custom-style = "Table or chart caption">Table 3: Difference between raw count of submitted appointment and optimised count of appointments in PT by health board, quarter ending June 2026 ^a^</Div>
