...
## PT total appointments DNAs

<Div custom-style = "Table or chart caption">Table 1: PT total appointments and total DNA rate by health board, March 2025 to June 2026 ^a^</Div>
...
knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_loc/tot_dna_age_sex_PT.png"))

```
    
### PT total DNA rate by age group by month
...
knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_loc/dna_agg_age_tt_PT.png"))

```   
    
### PT total DNA rate by SIMD and sex

<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by SIMD quintile and sex reported at referral, NHS Scotland, March 2025 to June 2026 </Div>
...
<Div custom-style = "Table or chart caption">Figure : Total appointment crude DNA rate by weekday of planned appointment, NHS Scotland, March 2025 to June 2026 </Div>
...
## PT first contact appointments DNAs

Of the `r figs_apps_qt$current_qt` total appointments in PT across NHS Scotland in the
latest quarter, `r figs_1st_apps$"1st contact appointments"` (`r figs_1st_apps$prop_first_con`)
were first contact appointments (Table 4). The first contact appointment is the 
first appointment date a patient is offered in their treatment journey
...
<Div custom-style = "Table or chart caption">Table 2: PT first contact appointments and first contact DNA rate by health board, March 2025 to June 2026 ^a^</Div>
...
knitr::include_graphics(paste0("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_", data_analysis_latest_date, "/shorewise_publication/data/appointments_firstcon/tot_dna_ur_sex_PT.png"))

```    
    
### PT first contact DNA rate by length of wait

<Div custom-style = "Table or chart caption">Figure : First contact DNA rate by length of wait in weeks for first contact appointment, NHS Scotland, March 2025 to June 2026 </Div>
