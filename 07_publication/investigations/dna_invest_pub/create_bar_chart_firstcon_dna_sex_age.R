...
create_bar_chart_dna_agg_age_sex <- function(dataset_choice){
  
  last_pub_period_dna_age_sex <- read_parquet(paste0(shorewise_pub_data_dir, "/appointments_firstcon/firstcon_dnas_qt_hb_age_sex.parquet")) |> 
    ungroup() |> 
  ...
  ggsave(paste0(shorewise_pub_data_dir, "/appointments_firstcon/dna_agg_age_sex_", dataset_choice, ".png"),
