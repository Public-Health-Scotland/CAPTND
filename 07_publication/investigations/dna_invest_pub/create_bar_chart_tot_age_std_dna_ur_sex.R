#############################################################################.
#### DNA Focused Publication - Total DNA Chart - UR and Sex, Std. by Age ####.
#############################################################################.

# Author: Luke Taylor
# Date: 2026-07-31

create_bar_chart_tot_dna_ur_sex_std_age <- function(dataset_choice){
  ...
  ggplot(plot_data, aes(x = ur8_2022_name, y = std_rate_by_ur_sex, fill = sex_reported)) +
    ...
    labs(
      ...
      y = "Total age standardised DNA risk (%)",
  ...
  ggsave(paste0(shorewise_pub_data_dir, "/appointments_att/age_std_dna_ur_sex_", dataset_choice, ".png"),
