###############################################################################.
#### DNA Focused Publication - First Contact DNA Chart by UR Class and Sex ####.
###############################################################################.

# Author: Luke Taylor
# Date: 2026-06-25

create_bar_chart_dna_ur_sex <- function(dataset_choice){
  ...
  ggsave(paste0(shorewise_pub_data_dir, "/appointments_firstcon/dna_ur_sex_", dataset_choice, ".png"),
