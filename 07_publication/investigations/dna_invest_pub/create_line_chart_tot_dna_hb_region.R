################################################################.
#### DNA Focused Publication - Total DNA Chart by HB Region ####.
################################################################.

# Author: Luke Taylor
# Date: 2026-06-25

create_line_plot_tot_dna_region <- function(dataset_choice){
  
  last_pub_period_dna_region <- read_parquet(paste0(shorewise_pub_data_dir, "/appointments_att/total_dnas_mth_hb_agg_age_group.parquet")) |> 
    ungroup() |> 
    add_hb_region() |> 
  ...
  ggsave(paste0(shorewise_pub_data_dir, "/appointments_att/dna_hb_region_", dataset_choice, ".png"),
