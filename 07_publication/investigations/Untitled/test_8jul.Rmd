...
table_data <- read_parquet("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_2024-06-28/shorewise_publication/data/basic_v_opti/table_refs_basic_opti_last_quart.parquet") 
...
table_data4 <- read_parquet("//PHI_conf/MentalHealth5/CAPTND/CAPTND_shorewise/output/analysis_2024-06-28/shorewise_publication/data/appointments_att/table apps_att_latest_qt.parquet")
...
<Div custom-style = "Table or chart caption">Figure 2: title ^1,2,\*,\ \*\*\ +\ footnote\ reference^</Div>
