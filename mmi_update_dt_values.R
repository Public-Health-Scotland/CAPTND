...
update_dt_values <- function(wb, time_period){
  ...
  assign(x = "wb", value = wb, envir = .GlobalEnv)
    ...
    addStyle(wb, sheet = "Tab 5", style = createStyle(halign = "right"), cols = 7, rows = 15:19, stack = TRUE)
    ...
    addStyle(wb, sheet = "Tab 6", style = createStyle(halign = "right"), cols = 8, rows = 15:19, stack = TRUE)
